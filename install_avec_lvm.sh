...
echo ""
echo "le log de votre installation est dans votre répertoire /home/$user/"
echo "-------------------------------"
echo "-------------------------------"
echo "Maintenant, rendez-vous sur Mediastorrent"
echo "http://$ip/Mediastorrent/"
echo ""
echo "support Forum url"
echo ""
echo "http://forum.mediastorrent.com/index.php/Thread/9-Script-support/"
